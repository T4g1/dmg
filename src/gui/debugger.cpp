...
void Debugger::display_execution()
{
    ...
    if (ImGui::Begin(title)) {
        ...
        while (address < cpu->PC + 0xFF && address < 0xFF00) {
            uint16_t new_address = translate(buffer, buffer_size, address);
...
uint16_t Debugger::translate(char buffer[], size_t size, uint16_t address)
{
    ...
    case 0x01: TRANSLATION(3, "%02X %02X // LD BC,0x%02X%02X", d0, d1, d1, d0);
    case 0x02: TRANSLATION(1, "      // LD (BC),A");
    case 0x03: TRANSLATION(1, "      // INC BC");
    case 0x04: TRANSLATION(1, "      // INC B");
    case 0x05: TRANSLATION(1, "      // DEC B");
    case 0x06: TRANSLATION(2, "%02X    // LD B,0x%02X", d0, d0);
    case 0x07: TRANSLATION(1, "      // RLCA");
    case 0x08: TRANSLATION(3, "%02X %02X // LD (0x%02X%02X),SP", d0, d1, d1, d0);
    ...
    case 0x1E: TRANSLATION(2, "%02X    // LD E,0x%02X", d0, d0);
    case 0x1F: TRANSLATION(1, "      // RRA");
    case 0x20: TRANSLATION(2, "%02X    // JR NZ,0x%02X", d0, d0);
    case 0x21: TRANSLATION(3, "%02X %02X // LD HL,0x%02X%02X", d0, d1, d1, d0);
    case 0x22: TRANSLATION(1, "      // LD (HLI),A");
    case 0x23: TRANSLATION(1, "      // INC HL");
    case 0x24: TRANSLATION(1, "      // INC H");
    case 0x25: TRANSLATION(1, "      // DEC H");
    case 0x26: TRANSLATION(2, "%02X    // LD H,0x%02X", d0, d0);
    case 0x27: TRANSLATION(1, "      // DAA");
    case 0x28: TRANSLATION(2, "%02X    // JR Z,0x%02X", d0, d0);
    ...
    case 0x2E: TRANSLATION(2, "%02X    // LD L,0x%02X", d0, d0);
    case 0x2F: TRANSLATION(1, "      // CPL");
    case 0x30: TRANSLATION(2, "%02X    // JR NC,0x%02X", d0, d0);
    case 0x31: TRANSLATION(3, "%02X %02X // LD SP,0x%02X%02X", d0, d1, d1, d0);
    ...
    case 0x36: TRANSLATION(2, "%02X    // LD (HL),0x%02X", d0, d0);
    case 0x37: TRANSLATION(1, "      // SCF");
    case 0x38: TRANSLATION(2, "%02X    // JR C,0x%02X", d0, d0);
    ...
    case 0x3E: TRANSLATION(2, "%02X    // LD A,0x%02X", d0, d0);
    ...
    case 0xC2: TRANSLATION(3, "%02X %02X // JP NZ,0x%02X%02X", d0, d1, d1, d0);
    case 0xC3: TRANSLATION(3, "%02X %02X // JP 0x%02X%02X", d0, d1, d1, d0);
    case 0xC4: TRANSLATION(3, "%02X %02X // CALL NZ,0x%02X%02X", d0, d1, d1, d0);
    case 0xC5: TRANSLATION(1, "      // PUSH BC");
    case 0xC6: TRANSLATION(2, "%02X    // ADD A,0x%02X", d0, d0);
    case 0xC7: TRANSLATION(1, "      // RST $00");
    case 0xC8: TRANSLATION(1, "      // RET Z");
    case 0xC9: TRANSLATION(1, "      // RET");
    case 0xCA: TRANSLATION(3, "%02X %02X // JP Z,0x%02X%02X", d0, d1, d1, d0);
    case 0xCB: TRANSLATION(2, "%02X    // CB %02X", d0, d0);
    case 0xCC: TRANSLATION(3, "%02X %02X // CALL Z,0x%02X%02X", d0, d1, d1, d0);
    case 0xCD: TRANSLATION(3, "%02X %02X // CALL 0x%02X%02X", d0, d1, d1, d0);
    case 0xCE: TRANSLATION(2, "%02X    // ADC A,0x%02X", d0, d0);
    case 0xCF: TRANSLATION(1, "      // RST $08");
    case 0xD0: TRANSLATION(1, "      // RET NC");
    case 0xD1: TRANSLATION(1, "      // POP DE");
    case 0xD2: TRANSLATION(3, "%02X %02X // JP NC,0x%02X%02X", d0, d1, d1, d0);
    case 0xD4: TRANSLATION(3, "%02X %02X // CALL NC,0x%02X%02X", d0, d1, d1, d0);
    case 0xD5: TRANSLATION(1, "      // PUSH DE");
    case 0xD6: TRANSLATION(2, "%02X    // SUB 0x%02X", d0, d0);
    case 0xD7: TRANSLATION(1, "      // RST $10");
    case 0xD8: TRANSLATION(1, "      // RET C");
    case 0xD9: TRANSLATION(1, "      // RETI");
    case 0xDA: TRANSLATION(3, "%02X %02X // JP C,0x%02X%02X", d0, d1, d1, d0);
    case 0xDC: TRANSLATION(3, "%02X %02X // CALL C,0x%02X%02X", d0, d1, d1, d0);
    case 0xDE: TRANSLATION(2, "%02X    // SBC A,0x%02X", d0, d0);
    case 0xDF: TRANSLATION(1, "      // RST $18");
    case 0xE0: TRANSLATION(2, "%02X    // LD (0x%02X),A", d0, d0);
    case 0xE1: TRANSLATION(1, "      // POP HL");
    case 0xE2: TRANSLATION(1, "      // LD (C),A");
    case 0xE5: TRANSLATION(1, "      // PUSH HL");
    case 0xE6: TRANSLATION(2, "%02X    // AND 0x%02X", d0, d0);
    case 0xE7: TRANSLATION(1, "      // RST $20");
    case 0xE8: TRANSLATION(1, "      // ADD SP,xx");
    case 0xE9: TRANSLATION(1, "      // JP (HL)");
    case 0xEA: TRANSLATION(3, "%02X %02X // LD (0x%02X%02X),A", d0, d1, d1, d0);
    case 0xEE: TRANSLATION(2, "%02X    // XOR 0x%02X", d0, d0);
    case 0xEF: TRANSLATION(1, "      // RST $28");
    case 0xF0: TRANSLATION(2, "%02X    // LD A,(0x%02X)", d0, d0);
    case 0xF1: TRANSLATION(1, "      // POP AF");
    case 0xF2: TRANSLATION(1, "      // LD A,(C)");
    case 0xF3: TRANSLATION(1, "      // DI");
    case 0xF5: TRANSLATION(1, "      // PUSH AF");
    case 0xF6: TRANSLATION(2, "%02X    // OR 0x%02X", d0, d0);
    case 0xF7: TRANSLATION(1, "      // RST $30");
    case 0xF8: TRANSLATION(1, "      // LD HL,SP");
    case 0xF9: TRANSLATION(1, "      // LD SP,HL");
    case 0xFA: TRANSLATION(3, "%02X %02X // LD A,(0x%02X%02X)", d0, d1, d1, d0);
    case 0xFB: TRANSLATION(1, "      // EI");
    case 0xFE: TRANSLATION(2, "%02X    // CP 0x%02X", d0, d0);
